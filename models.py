...
class NearEarthObject:
    ...
    def fullname(self):
        ...
        return self.designation + (" (" + self.name + ")" if self.name else "")
    ...
    def __str__(self):
        ...
        return f"NEO {self.fullname} has a diameter of {self.diameter:.3f}km and is {'not' if self.hazardous else ''} potentially hazardous."
